  ...
  return (
    <div className="bg-white rounded-2xl border border-black/[0.08] p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-neutral-100">
        <div>
          <p className="text-xs text-neutral-400 mb-1 font-normal">Average/Month</p>
          <p className="text-lg font-light text-black tracking-tight">Rs. 438K</p>
        </div>
        <div>
          <p className="text-xs text-neutral-400 mb-1 font-normal">Highest</p>
          <p className="text-lg font-light text-black tracking-tight">Rs. 482K</p>
        </div>
        <div>
          <p className="text-xs text-neutral-400 mb-1 font-normal">Total (6 months)</p>
          <p className="text-lg font-light text-black tracking-tight">Rs. 2.63M</p>
        </div>
      </div>
    </div>
  );
